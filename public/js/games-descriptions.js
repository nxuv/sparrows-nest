...
### *A rally for the ages - hopefully.*

Inspired by **[Ech0](https://roleoverplaydead.itch.io/ech0)**, **[Helan](https://pinayu.itch.io/helan)**, **[Art of Rally](https://www.gog.com/en/game/art_of_rally)** and **[Slipstream](https://www.gog.com/en/game/slipstream)**, **Sulay Rally Raid** is a **journaling RPG for 1 to 2 players**, in which you and (potentially) a friend take the role of **rally drivers** (or rally crew) embarked in an **offroad endurance race** sprawling across **two rival nations** in a process of **tentative detente.**

Starting from the northern capital of **Kaburgrad**, take it to the road in your **Puma SUV** and drive from town to town towards **Nawi Kandahar**, the region's southern capital and final goal of the rally. Roll your **daily route** and see what you run into along the way: from **mountain hairpins** to **rampant wardrones**, everything's written down in a series of **Event Tables** split between **Maneuvers, Hitches** and **Shenanigans** - special events you may roll for once you reach a town.

By default, your journey is **not timed** and there is **no extrinsic "reward"** for reaching the southern capital in the least days possible: whether you **rush through the steppes** or **hit every single town** in the region**, what matters is that you write it down** and **enjoy doing so**.
